...
- コンポーネント間の疎通はグローバルステート (ManuscriptState / BreakState / DocumentState / ZoomState) と導出サービス Paginator の購読、操作サービス Editor への命令で行う。input/output は FileAddInput の selected など最小限
